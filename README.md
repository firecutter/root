...
Este projeto tem como objetivo oferecer:
- Cadastro de vendedores e compradores
- Login com autenticação JWT
- Gerenciamento de produtos, categorias, variações e estoque
- Página pública que lista lojas em carrossel
- Busca global por produtos
- Carrinho de compras e checkout (PIX)
